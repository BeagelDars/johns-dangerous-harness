#!/usr/bin/env python3
"""
Autonomous Cloud Scraper: books_scraper
Target: http://books.toscrape.com
Criteria: Extract book titles, prices, ratings, and availability, and save them to a JSON artifact or notify if new books or price drops occur.
Scheduled via GitHub Actions (Cron: 0 */2 * * *)
"""
import os
import sys
import json
...
CRITERIA = "Extract book titles, prices, ratings, and availability, and save them to a JSON artifact or notify if new books or price drops occur."
DATA_FILE = os.path.join(os.path.dirname(__file__), "data", "books_scraper_results.json")
